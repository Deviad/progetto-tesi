...
public class Address {
    ...
    public Address(String firstAddressLine, String secondAddressLine, String city, String country) {
        validate(firstAddressLine, secondAddressLine, city, country);
    ...
    public void validate(String... addressElements) {
        List.of(addressElements).forEach((el) -> {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((this.firstAddressLine() == null) ? 0 : this.firstAddressLine().hashCode());
        result = prime * result + ((this.secondAddressLine() == null) ? 0 : this.secondAddressLine().hashCode());
